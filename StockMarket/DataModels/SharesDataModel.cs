...
namespace StockMarket
{
    ...
    {
        /// <summary>
        /// Gets or sets a list of <see cref="Share"/>s within a database.
        /// </summary>
        public List<Share> Shares { get; set; }

        /// <summary>
        /// Gets or sets a list of <see cref="Order"/>s within a database.
        /// </summary>
        public List<Order> Orders { get; set; }

        /// <summary>
        /// Gets or sets a list of <see cref="ShareValue"/>s within a database.
        /// </summary>
